...
public class Main {
    ...
    public  static ArrayList<Event> selectEvents(Connection conn, boolean isAsc, int offset) throws SQLException {
        ...
        String query = String.format("SELECT * FROM events ORDER BY start_date %s LIMIT ? OFFSET ?"
                , isAsc ? "ASC" : "DESC");
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Spark.get(
                ...
                ((request, response) -> {
                    ...
                    m.put("now", LocalDateTime.now()); // this will set the date form to current date
